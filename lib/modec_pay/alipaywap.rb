...
module ModecPay
    ...
    @@mer_id = '2088811350436863'
    @@private_key  = 'y6esw2261qtye8z1dhgvssb3j0absm8z'
    @@seller_account_name='payment@unizimmo.com'
    ...
    #  self.sorter = ['service','req_data','partner','req_id','sec_id', 'format','v']
      ...
      @merchant_url = 'http://www.unizimmo.com' #操作中断返回地址,可空
