...
WeixinRailsMiddleware::WeixinController.class_eval do
  ...
  def response_news_message(options={})
    ...
    appid = 'wx86ae414b7f515790'#@weixin_public_account.weixin_appid
    ...
    case @keyword
      when '授权'
        ...
        title="二维码"
        desc =""
        pic_url="http://www.unizimmo.com/images/a0#{id}/homepage/getqrcode_h.jpg"
        link_url="http://www.unizimmo.com/images/a0#{id}/homepage/getqrcode.jpg"

        title1="关于我们"
        desc1 =""
        pic_url1="http://www.unizimmo.com/images/a0#{id}/homepage/logo.jpg"
        link_url1="http://www.unizimmo.com/pages/#{@weixin_public_account.url}_aboutus"
      ...
      when '买'
        ...
        pic_url="http://www.unizimmo.com/images/a072/a0729002_b_1.jpg"
        link_url="http://www.unizimmo.com/mproducts?id=a980000&fp=mproducts&supplier_id=#{id}"
        articles = [generate_article(title, desc, pic_url, link_url)]

      when 'on_sale'
        title="法兰克福香肠350克/ Frankfurter Sausages 350g仅售¥40元"
        desc =""
        pic_url="http://www.unizimmo.com/images/a077/a0771030_m.jpg"
        link_url="http://www.unizimmo.com/mproducts?id=a0771030&from=weixin&wechatuser=#{user}&supplier_id=#{id}"
        articles = [generate_article(title, desc, pic_url, link_url)]     

      when 'new'
        title="那不勒斯萨拉米香肠200克"
        desc =""
        pic_url="http://www.unizimmo.com/images/a077/a0771043_m.jpg"
        link_url="http://www.unizimmo.com/mproducts?id=a0771043&from=weixin&wechatuser=#{user}&supplier_id=#{id}"
        articles = [generate_article(title, desc, pic_url, link_url)]
      ...
      when '测试'
        ...
        desc ="测试商品0.01元，佣金3.00元"
        pic_url="http://www.unizimmo.com/images/a072/a0729002_b_1.jpg"
        link_url="http://www.unizimmo.com/mproducts?id=a980000&fp=mproducts&supplier_id=#{id}&from=weixin&wechatuser=#{user}"
        articles = [generate_article(title, desc, pic_url, link_url)]
      ...
      when 'share'
        ...
        desc ="查看佣金详情请点击"
        pic_url='http://www.unizimmo.com/assets/vshop/commission_banner.jpg'
        link_url="http://www.unizimmo.com/share?FromUserName=#{user}&supplier_id=#{id}"
        ...
        articles = [generate_article(title, desc, pic_url, link_url),generate_article(title1, desc1, pic_url1, link_url1)]
      when 'subscribe'
        title="您好，滋贸万国欢迎您的光临！羊年团洋车"
        desc =""
        pic_url="http://www.unizimmo.com/image/slide2.jpg"
        link_url="http://www.unizimmo.com/pages/yntyc"     
        articles = [generate_article(title, desc, pic_url, link_url)]
     
      else
        desc =""
        title="您好，我们将尽快回复您的问题"
        pic_url="http://www.unizimmo.com/images/a0#{id}/homepage/logo.jpg"
        link_url="http://www.unizimmo.com/vshop/#{id}"
        articles = [generate_article(title, desc, pic_url, link_url)]
    end
    if articles
